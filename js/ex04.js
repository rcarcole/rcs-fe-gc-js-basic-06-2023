// Declarar una variable llamada "temperaturaCelsius" y asignarle un valor numérico que
...
let temperaturaCelsius = 5;
let resultado = (temperaturaCelsius * 9/5) + 32;

console.log('La temperatura a grados Fahrenheit es: '+resultado);